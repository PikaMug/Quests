 ...
 */
public class BukkitQuesterPostFailQuestEvent extends BukkitQuesterEvent {
    private static final HandlerList HANDLERS = new HandlerList();
    private final Quest quest;
    
    public BukkitQuesterPostFailQuestEvent(final BukkitQuester quester, final Quest quest) {
        super(quester);
        this.quest = quest;
    }
