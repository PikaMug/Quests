...
/**
 * Delegates permission checks to LuckPerms. Only instantiated when the
 * LuckPerms mod is present, so its API classes are never linked otherwise.
 */
public class FabricLuckPermsAccessor {
