 ...
 */
public class BukkitQuesterPreUpdateObjectiveEvent extends BukkitQuesterEvent implements Cancellable {
    private static final HandlerList HANDLERS = new HandlerList();
    private final Quest quest;
    private final Objective objective;
    private boolean cancel = false;
    
    public BukkitQuesterPreUpdateObjectiveEvent(final BukkitQuester quester, final Quest quest, final Objective objective) {
        super(quester);
        this.quest = quest;
