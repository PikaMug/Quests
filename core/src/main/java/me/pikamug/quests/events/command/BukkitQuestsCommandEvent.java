 ...
 */
public abstract class BukkitQuestsCommandEvent extends QuestsEvent {
    private static final HandlerList HANDLERS = new HandlerList();
    private final BukkitQuester quester;
    
    public BukkitQuestsCommandEvent(final BukkitQuester quester) {
        this.quester = quester;
    }
    
    public BukkitQuestsCommandEvent(final BukkitQuester quester, final boolean async) {
        super(async);
        this.quester = quester;
    }
